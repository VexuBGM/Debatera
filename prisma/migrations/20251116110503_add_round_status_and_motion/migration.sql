-- CreateEnum
CREATE TYPE "RoundStatus" AS ENUM ('PLANNING', 'PUBLISHED', 'BALLOTING', 'FINAL', 'CANCELLED');
...
-- AlterTable
ALTER TABLE "Round" ADD COLUMN     "motion" TEXT,
ADD COLUMN     "status" "RoundStatus" NOT NULL DEFAULT 'PLANNING',
